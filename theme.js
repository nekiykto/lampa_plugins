...
var CONFIG = {
        ...
        API: {
            ...
            JACRED_URL: 'https://jacred.torrservera.net'
        },
        PERFORMANCE: {
            DEBOUNCE_DELAY: 0,
            THROTTLE_LIMIT: 0,
...
jacred_prompt: { ru: 'Введите JacRed URL (например: jacred.torrservera.net):', en: 'Enter JacRed URL (e.g. jacred.torrservera.net):', uk: 'Введіть JacRed URL (наприклад: jacred.torrservera.net):' },
...
drxaos_overlay_jacred_hint: { ru: 'Укажите адрес без http:// или https://. Например: jacred.torrservera.net', en: 'Specify address without http:// or https://. Example: jacred.torrservera.net', uk: 'Вкажіть адресу без http:// чи https://. Наприклад: jacred.torrservera.net' },
drxaos_overlay_jacred_placeholder: { ru: 'например: jacred.torrservera.net', en: 'e.g. jacred.torrservera.net', uk: 'наприклад: jacred.torrservera.net' },
...
function addSettings() {
    ...
    if (!Lampa.Storage.get('jacred_url')) {
        drxaosSafeSet('jacred_url', 'jacred.torrservera.net');
    }
    ...
    */
    ...
    function ensureIntegrationDefaults() {
            try {
                ...
                if (!jacredUrl || jacredUrl === 'jacred.xyz') {
                    jacredUrl = 'jacred.torrservera.net';
                }
    ...
    Lampa.SettingsApi.addParam({
        ...
        type: 'select',
        values: {
            'jacred.torrservera.net': 'jacred.torrservera.net (default)',
            'jacred.net': 'jacred.net',
            'custom': 'Enter custom URL...'
        },
        default: 'jacred.torrservera.net'
    },
        field: {
        name: '🌐 JacRed URL',
        ...
        if (value === 'custom') {
            ...
            inputOverlay.open({
                ...
                if (result.action === 'clear') {
                    ...
                    drxaosSafeSet('jacred_url', 'jacred.torrservera.net');
                    if (Lampa.Noty) {
                        Lampa.Noty.show(Lampa.Lang.translate('jacred_saved') + 'jacred.torrservera.net');
                    }
                    applyMovieQuality();
                    scheduleDrxaosApplyAll();
                    return;
...
function applyMovieQuality() {
    ...
    var jacredUrl = Lampa.Storage.get('jacred_url', 'jacred.torrservera.net');
    if (!jacredUrl) {
        if (Lampa.Noty) {
